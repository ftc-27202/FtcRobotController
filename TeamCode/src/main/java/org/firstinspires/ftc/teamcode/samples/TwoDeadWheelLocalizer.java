...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1135.8904579605592; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 4557.447802546102; // x position of the perpendicular encoder (in tick units)
    }
