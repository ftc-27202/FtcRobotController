...
public class DriveConstants {
    ...
    public static double TRACK_WIDTH = 14.86; // in
     ...
     * empirically tuned.
     */
    public static double kV = 1.0175 / rpmToVelocity(MAX_RPM);
     ...
     * inches.
     */
    // Nov 3, 2024 original prior to overwriting
//    public static double MAX_VEL = 52.48180821614297;
//    public static double MAX_ACCEL = 52.48180821614297;
//    public static double MAX_ANG_VEL = Math.toRadians(266.58818458904058);
//    public static double MAX_ANG_ACCEL = Math.toRadians(184.02607784577722);
    ...
    public static double MAX_ANG_VEL = Math.toRadians(267.17722010306244);
